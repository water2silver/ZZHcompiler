...
#define REG_ALLOC_SIMPLE_SRC1_REG_NO 8
#define REG_ALLOC_SIMPLE_SRC2_REG_NO 9
#define REG_ALLOC_SIMPLE_DST_REG_NO 10

// 在操作过程中临时借助的寄存器为REG_ALLOC_SIMPLE_TMP_REG_NO
#define REG_ALLOC_SIMPLE_TMP_REG_NO 12
