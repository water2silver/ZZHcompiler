 ...
 */
static int parse_long_options(char ** nargv, const char * options, const struct option * long_options, int * idx,
                              int short_too)
{
    ...
    has_equal = strchr((char *) current_argv, '=');
    if (has_equal != NULL) {
 ...
 */
static int getopt_internal(int nargc, char ** nargv, const char * options, const struct option * long_options,
                           int * idx, int flags)
{
    ...
    if (!posixly_correct || *options == '+') flags &= ~FLAG_PERMUTE;
    else if (*options == '-')
        flags |= FLAG_ALLARGS;
...
start:
    ...
    optchar = (int) *place++;
    oli = strchr((char *) options, optchar);
 ...
 *	Parse argc/argv argument vector.
 */
int getopt_long(int nargc, char * nargv[], const char * options, const struct option * long_options, int * idx)
{
 ...
 *	Parse argc/argv argument vector.
 */
int getopt_long_only(int nargc, char * nargv[], const char * options, const struct option * long_options, int * idx)
{
