...
{
       0,     0,     3,     5,     7,    10,    13,    19,    26,    28,
      32,    34,    36,    39,    43,    45,    48,    50,    55,    58,
      60,    64,    66,    70,    74,    76,    78,    82,    87,    91,
      93,    95,    97,    99
};
...
{
      17,     0,    -1,    18,    -1,    25,    -1,    17,    18,    -1,
      17,    25,    -1,     5,     4,     9,    10,    22,    -1,     5,
       4,     9,    19,    10,    22,    -1,    20,    -1,    19,    11,
      20,    -1,    21,    -1,     4,    -1,    12,    13,    -1,    12,
      23,    13,    -1,    24,    -1,    23,    24,    -1,    25,    -1,
       4,    14,    26,    15,    -1,    26,    15,    -1,    26,    -1,
       6,    26,    15,    -1,    27,    -1,    27,     7,    28,    -1,
      27,     8,    28,    -1,    28,    -1,    29,    -1,     4,     9,
      10,    -1,     4,     9,    31,    10,    -1,     9,    26,    10,
      -1,     3,    -1,    30,    -1,     4,    -1,    26,    -1,    31,
      11,    26,    -1
};
...
{
  "$end", "error", "$undefined", "T_DIGIT", "T_ID", "T_FUNC", "T_RETURN",
  "T_ADD", "T_SUB", "'('", "')'", "','", "'{'", "'}'", "'='", "';'",
  "$accept", "CompileUnit", "FuncDef", "FuncFormalParams",
  "FuncFormalParam", "FuncBasicParam", "Block", "BlockItemList",
  "BlockItem", "Statement", "Expr", "AddExp", "UnaryExp", "PrimaryExp",
  "LVal", "RealParamList", 0
};
#endif
...
#line 137 "Calculator.y"
    {
        ...
        (yyval.node) = new_ast_node(ast_operator_type::AST_OP_ASSIGN, new_ast_leaf_node((yyvsp[(1) - (4)].var_id).id, -1), (yyvsp[(3) - (4)].node), nullptr);
    ;}
    break;
...
#line 204 "Calculator.y"
    {
        ...
        // 终结符作为抽象语法树的叶子节点进行创建
        (yyval.node) = new_ast_leaf_node((yyvsp[(1) - (1)].integer_num).val, (yyvsp[(1) - (1)].integer_num).lineno);
    ;}
    break;
...
#line 216 "Calculator.y"
    {
        // 终结符作为抽象语法树的叶子节点进行创建
        (yyval.node) = new_ast_leaf_node((yyvsp[(1) - (1)].var_id).id, (yyvsp[(1) - (1)].var_id).lineno);
    ;}
    break;
